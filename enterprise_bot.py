...
# HTML landing page (embedded)
LANDING_PAGE = """
<!DOCTYPE html>
<html>
<head>
    <title>Pearl Street Family Insurance - Free Quote</title>
...
# Replace with your actual page access token when ready
...
def post_to_facebook():
    if FACEBOOK_PAGE_ID == "YOUR_PAGE_ID":
        ...
        return
    message = "Get your free auto insurance quote today! https://pearlstreetfamilyinsurance.com"
...
# Schedule posts at 9am and 3pm daily
...
if __name__ == "__main__":
    print("\n" + "="*60)
    print("PEARL STREET FAMILY INSURANCE - ENTERPRISE LEAD SYSTEM")
    print("="*60)
